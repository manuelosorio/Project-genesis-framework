...
<div class="container">
  <div id="video_player">
    <video id="video">
      <source src="Intro-StormofColorRunfixed.mp4" type="video/mp4">
      <!-- Safari / iOS, IE9-->
      ...
      <div class="loading">I have a bad feeling about this... <br>
      ... your browser doesn't support the video format!</div>
    </video>
